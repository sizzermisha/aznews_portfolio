...
<?php require_once './function/posts/get_posts.php'; ?>
    <main>
    <!-- Trending Area Start -->
        ...
        <div class="container">
            <div class="trending-main">
                ...
                <div class="row">
					<div class="col-lg-8">
						<!-- Trending Top -->
						<?php foreach(connect()->query("SELECT * FROM posts WHERE area_select = 1 LIMIT 1") as $select) {
							if($select != NULL)
								print_post($select['id'], $select['area_select']);
						} ?>
						<!-- Trending Bottom -->
						<div class="trending-bottom">
							<div class="row">
								<?php foreach (connect()->query("SELECT * FROM posts WHERE area_select = 2") as $post) {
									if($post != NULL)
										print_post($post['id'], $post['area_select']);						
								} ?>
							</div>
						</div>
					</div>
					...
					<!-- Right Content -->
					<div class="col-lg-4">
						<?php foreach (connect()->query("SELECT * FROM posts WHERE area_select = 3") as $post) {
							if($post != NULL)
								print_post($post['id'], $post['area_select']);						
						} ?>
					</div>
